...
function init() {
  ...
  var slide = new Slide(width, height, 'out');
	...
	l1.load('/img/printing/a11.jpg', function(img) {
	  slide.setImage(img);
	})
  ...
  var l2 = new THREE.ImageLoader();
	...
	l2.load('/img/printing/a44.jpg', function(img) {
		slide2.setImage(img);
	})
  ...
  var l3 = new THREE.ImageLoader();
	...
	l3.load('/img/printing/a55.jpg', function(img) {
		slide3.setImage(img);
	})
...
function Slide(width, height, animationPhase) {
  ...
  var aControl2 = geometry.createAttribute('aControl2', 3);
  ...
  var control2 = new THREE.Vector3();
